            ...
            <form @submit.prevent="saveServer">
                ...
                <div class="hvn-d-flex hvn-justify-content-between hvn-pt-3 hvn-border-top">
                    ...
                    <div class="hvn-gap-2 hvn-d-flex">
                        <a href="{$modulelink}&action=servers" class="hvn-btn hvn-btn-outline-secondary" :class="{ 'disabled': submitting }">Quay lại</a>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('serverEditor', () => ({
        isEdit: false, // Set to true if ID is present (Mock)
        ...
        init() {
            ...
            if (id) {
                this.isEdit = true;
                this.form = { 
                    id: id, hostname: 'dns1.hvn.vn', ip_address: '103.45.67.10', port: 2222, 
                    use_ssl: true, username: 'admin', password: '', is_primary: true, max_concurrent_jobs: 50, notes: 'Hà Nội DC'
                };
            }
        },
        ...
        saveServer() {
            ...
            setTimeout(() => {
                ...
                window.location.href = '{/literal}{$modulelink}&action=servers{literal}';
            }, 800);
        },
