...
<script>
        ...
        function convertDOMAIN(id){
            if (document.getElementById(id).value == "@") document.getElementById(id).value = domaindot;
        }
        {/literal}
        ...
        {if $configs.enablednssec == "on"}
            {literal}
                $(function() {
                    $("#enableDNSSECbtn").tooltip();
                });
            {{/literal}}
        {/if}
        ...
        {if $configs.enablednssec == "on"}
            {literal}
            function enableDNSSECConfirm(form){
                $('#enableDNSSECmodal').modal({
                    backdrop: 'static',
                    keyboard: true
                })
                    .one('click', '#deletebutton', function(e) {
            ...
            function disableDNSSECConfirm(form){
                $('#disableDNSSECmodal').modal({
                    backdrop: 'static',
                    keyboard: true
                })
                    .one('click', '#deletebutton', function(e) {
...
{else}
    ...
    {if $configs.enablednssec == "on"}
        <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="enableDNSSECmodal">
            <div class="modal-dialog" role="document" >
                <div class="modal-content" style="padding:0px">
                    <div class="modal-header-warning">
                        <h5 class="modal-title" id="exampleModalLabel">{$ADDONLANG.dnssuitePage_manage_js_endablednssecconfirm}</h5>
                    </div>
                    <div class="modal-body" id="validateresp">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="disableDNSSECmodal">
            <div class="modal-dialog" role="document" >
                <div class="modal-content" style="padding:0px">
                    <div class="modal-header-warning">
                        <h5 class="modal-title" id="exampleModalLabel">{$ADDONLANG.dnssuitePage_manage_js_disablednssecconfirm}</h5>
                    </div>
                    <div class="modal-body" id="validateresp">
                        {$ADDONLANG.dnssuitePage_manage_overview_dnssec_disable_warning}
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="deletebutton"><i class="fa fa-check"></i></button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-ban"></i></button>
            ...
            <div class="col-xs-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home-v">
                        {if $switchns == true || $resetdomain == true || $createuserdnstemplate == true || $deleteuserdnstemplate == true || $restorednstemplate == true || $updatenotification == true || $cleardns == true || $enablednssec_success == true || $disablednssec_success == true}
                            <div class="alert alert-success">
                                {$noticemsg}
                            </div>
                        {/if}
                        {if $switchnsfailed == true || $resetdomainfailed || $createuserdnstemplatefailed == true || $deleteuserdnstemplatefailed == true || $restorednstemplatefailed == true ||$updatenotificationfailed == true || $cleardnsfailed == true || $enablednssec_failed == true || $disablednssec_failed == true}
                        ...
                        {if ($disablemanage == "on" && $nsfail != true) || $disablemanage != "on" }
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel panel-primary panel-table">
                                            <div class="panel-heading">
                                                <div class="row">
                                                    <div class="col col-xs-12">
                                                        <h3 class="panel-title">{$ADDONLANG.dnssuitePage_manage_dnssec}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <p>{$ADDONLANG.dnssuitePage_manage_overview_dnssec} {if $dnssec_status == true} <font color="green">{$ADDONLANG.dnssuitePage_manage_dnssec_on}</font> {else} <font color="red"> {$ADDONLANG.dnssuitePage_manage_dnssec_off}</font> {/if}</p>
                                                    {if $dnssec_status == true} 
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                <th scope="row">{$ADDONLANG.dnssuitePage_manage_dnssec_ds}</th>
                                                                <td></td>
                                                                <td>{$dnssec_keys.DS}</td>
                                                                </tr>
                                                                <tr>
                                                                <th scope="row">{$ADDONLANG.dnssuitePage_manage_dnssec_zsk}</th>
                                                                <td></td>
                                                                <td>{$dnssec_keys.zsk}</td>
                                                                </tr>
                                                                <tr>
                                                                <th scope="row">{$ADDONLANG.dnssuitePage_manage_dnssec_ksk}</th>
                                                                <td></td>
                                                                <td>{$dnssec_keys.ksk}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                <th scope="col"></th>
                                                                <th scope="col">{$ADDONLANG.dnssuitePage_manage_dnssec_digest}</th>
                                                                <th scope="col">{$ADDONLANG.dnssuitePage_manage_dnssec_keytag}</th>
                                                                <th scope="col">{$ADDONLANG.dnssuitePage_manage_dnssec_algorithm}</th>
                                                                <th scope="col">{$ADDONLANG.dnssuitePage_manage_dnssec_type}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                        ...
                                                        <p><font color="red">{$ADDONLANG.dnssuitePage_manage_overview_dnssec_enable_warning}</font></p>
                                                        <p>
                                                            <form method="post" action="{$modulelink}&action=manage">
                                                                <input type="hidden" name="domainid" value="{$domainid}"/>
                                                                <input type="hidden" name="disableDNSSEC" value="yes"/>
                                                                <button type="submit" id="disableDNSSECbtn" class="btn btn-danger btn-sm" onClick="event.preventDefault(); disableDNSSECConfirm(this.form)" title=""><i class="fa fa-toggleoff"></i> {$ADDONLANG.dnssuitePage_manage_dnssec_disable}</button>
                                                            </form>
                                                        </p>
                                                    {else}
                                                        <p>
                                                            <form method="post" action="{$modulelink}&action=manage">
                                                                <input type="hidden" name="domainid" value="{$domainid}"/>
                                                                <input type="hidden" name="enableDNSSEC" value="yes"/>
                                                                <button type="submit" id="enableDNSSECbtn" class="btn btn-success btn-sm" onClick="event.preventDefault(); enableDNSSECConfirm(this.form)" title="{$ADDONLANG.dnssuitePage_manage_overview_dnssec_tooltip}"><i class="fa fa-shield"></i> {$ADDONLANG.dnssuitePage_manage_dnssec_enable}</button>
                                                            </form>
                                                        </p>
                                                    {/if}
                                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-striped" id="Atable">
                                                ...
                                                {if $records_a.limit==0 || $records_a.limit > $recordcount.a}
                                                    <tr>
                                                        <td><input type="text" id="addA-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                                                        <td>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-striped" id="AAAAtable">
                                    ...
                                    {if $records_aaaa.limit==0 || $records_aaaa.limit > $recordcount.aaaa}
                                        <tr>
                                            <td><input type="text" id="addAAAA-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped" id="NStable">
                                ...
                                {if $records_ns.limit==0 || $records_ns.limit > $recordcount.ns}
                                    <tr>
                                        <td><input type="text" id="addNS-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped" id="CNAMEtable">
                                ...
                                {if $records_cname.limit==0 || $records_cname.limit > $recordcount.cname}
                                    <tr>
                                        <td><input type="text" id="addCNAME-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                        ...
                        <div class="col-sm-12">
                            <table id="TXTtable" class="table table-striped">
                                ...
                                {if $records_txt.limit==0 || $records_txt.limit > $recordcount.txt}
                                    <tr>
                                        <td><input type="text" id="addTXT-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                        ...
                        <div class="col-sm-12">
                            <table id="MXtable" class="table table-striped">
                                ...
                                {if $records_mx.limit==0 || $records_mx.limit > $recordcount.mx}
                                    <tr>
                                        <td><input type="text" id="addMX-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" onchange="convertDOMAIN(this.id)"/></td>
                                        <td>
                        ...
                        <div class="col-sm-12">
                            <table id="SRVtable" class="table table-striped">
                                ...
                                {if $records_srv.limit==0 || $records_srv.limit > $recordcount.srv}
                                    <tr>
                                        <td><input type="text" id="addSRV-host" placeholder="{$ADDONLANG.dnssuitePage_manage_host}" size="10" onchange="convertDOMAIN(this.id)"/></td>
